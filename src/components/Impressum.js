function Impressum() {
  return (
    <div className="container">
      <h1 className="text-center header-color py-2">Impressum</h1>
      <h4 className="header-color text-decoration-underline">
        Angaben gem. § 5 TMG:
      </h4>
      <p>Manuel, Neubauer</p>
      <p>Ringstraße 1a, 96358 Teuschnitz</p>
      <h4 className="header-color text-decoration-underline">
        Kontaktaufnahme:
      </h4>
      ...
      <h6 className="header-color text-decoration-underline">Urheberrecht </h6>
      <p>
